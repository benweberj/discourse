...
export default _ => (
  <>
    ...
    <P>
      ...
      officers who share his disgust of the direction of the country. The plan that they developed involved taking advantage of Hitler's contigency plan, Operation Walküre (Valkyrie).
      This order would be enacted in the event that Hitler is killed or cut out of power, deploying thousands of reserve army soliders stationed around the country.
    ...
    <P>
      ...
      and are seen as the good guys. This film constructs a geopoplitical imaginary about Germany that attempts to <b>reverse these common misconceptions about Germans</b> and show
      ...
      There was no point in the film where the Hitler's atrocities were actually shown, but they are mentioned, and the opening scene lays out that there is a widespead
